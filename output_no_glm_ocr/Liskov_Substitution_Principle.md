...
![Sidebar: Unified Notation 0.8 — UML-style diagram: Base Class used by 'Used' (dashed arrow), had by Reference (open square),…](Liskov_Substitution_Principle/assets/page-001-img-01.png)
...
Sidebar: Unified Notation 0.8 — UML-style diagram: Base Class used by 'Used' (dashed arrow), had by Reference (open square), Had By Value (filled square), and generalization to Derived 1 and Derived 2
...
*A UML class diagram titled 'Figure 1.' showing Square inheriting from Rectangle via a generalization arrow.*
...
This use of the ISA relationship is considered by many to be one of the fundamental techniques of Object Oriented Analysis. A square is a rectangle, and so the `Square` class should be derived from the `Rectangle` class. However this kind of thinking can lead to some subtle, yet significant, problems. Generally these problems are not foreseen until we actually try to code the application.
...
*A UML class hierarchy showing Set as a parent class with BoundedSet and UnboundedSet as subclasses, each aggregating a corresponding ThirdParty class (ThirdPartyBoundedSet and ThirdPartyUnboundedSet).*

<details>
<summary>Original figure</summary>

![UML class diagram of a container hierarchy](Liskov_Substitution_Principle/assets/page-007-img-01.png)
...
![Code listing: PrintSet function](Liskov_Substitution_Principle/assets/page-008-img-01.png)
...
classDiagram
    ...
    Set <|-- PersistentSet
    ThirdParty <|.. ThirdPartyPersistentSet
    PersistentSet o-- ThirdPartyPersistentSet
    PersistentObject <|.. ThirdPartyPersistentSet
```

*UML class diagram showing PersistentSet inheriting from Set, ThirdParty PersistentSet implementing the ThirdParty interface and depending on PersistentObject, with an aggregation between PersistentSet and ThirdParty PersistentSet.*

<details>
<summary>Original figure</summary>

![UML diagram: Set, PersistentSet, ThirdParty PersistentSet, PersistentObject](Liskov_Substitution_Principle/assets/page-008-img-02.png)
...
classDiagram
    class IterableContainer {
        <<Abstract>>
        Allows iterators to be created.
    }
...
*UML class diagram showing abstract classes IterableContainer and MemberContainer with Set and PersistentSet as siblings under MemberContainer, and PersistentSet aggregating ThirdPartyPersistentSet which derives from PersistentObject.*

<details>
<summary>Original figure</summary>

![UML diagram: Separate Hierarchy](Liskov_Substitution_Principle/assets/page-010-img-01.png)
