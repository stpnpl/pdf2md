...
*UML class diagram showing Base Class with two derived classes (Derived 1, Derived 2), aggregation to 'Had by Reference', composition to 'Had By Value', and a dashed dependency to 'Used'.*

<details>
<summary>Original figure</summary>

![Sidebar diagram: Unified Notation 0.8 showing a Base Class with a Used box (dashed arrow), Had by Reference and Had By Value…](Interface_Segration_Principle/assets/page-001-img-01.png)
...
Sidebar diagram: Unified Notation 0.8 showing a Base Class with a Used box (dashed arrow), Had by Reference and Had By Value boxes (aggregation diamonds), and Derived 1 and Derived 2 boxes beneath a generalization triangle
...
*UML class hierarchy showing TimedDoor inheriting from Door, which inherits from TimerClient (at top of hierarchy).*

<details>
<summary>Original figure</summary>

![UML class diagram: TimedDoor inherits from Door, which inherits from TimerClient](Interface_Segration_Principle/assets/page-003-img-01.png)
...
*UML class diagram: TimedDoor inherits abstract Door, DoorTimer Adapter inherits abstract TimerClient, TimedDoor aggregates DoorTimer Adapter, and a dashed dependency arrow points from TimedDoor to DoorTimer Adapter.*

<details>
<summary>Original figure</summary>

![UML diagram: TimedDoor inherits from Door (Abstract); DoorTimerAdapter inherits from TimerClient (Abstract); DoorTimerAdapte…](Interface_Segration_Principle/assets/page-006-img-01.png)
...
*UML class diagram titled 'Multiply Inherited Timed Door' showing TimedDoor inheriting from both Door and TimerClient via multiple inheritance.*
...
*UML class diagram showing abstract class 'ATM UI' with three subclasses 'Braille UI', 'Screen UI', and 'Speech UI' connected via inheritance.*

<details>
<summary>Original figure</summary>

![UML diagram: abstract class ATM UI inheriting into Braille UI, Screen UI, and Speech UI](Interface_Segration_Principle/assets/page-008-img-01.png)
...
*UML class diagram (Figure 5/6): abstract Transaction class specialized by Deposit, Withdrawl, and Transfer Transaction classes, all depending on an abstract UI class.*

<details>
<summary>Original figure</summary>

![UML diagram: abstract Transaction class with Deposit, Withdrawl, and Transfer Transaction derivatives, dashed dependency arr…](Interface_Segration_Principle/assets/page-009-img-01.png)
...
UML diagram: abstract Transaction class with Deposit, Withdrawl, and Transfer Transaction derivatives, dashed dependency arrows pointing to abstract UI class
...
classDiagram
    ...
    class DepositUI["Deposit UI\n<<Abstract>>"]
    class WithdrawlUI["Withdrawl UI\n<<Abstract>>"]
    class TransferUI["Transfer UI\n<<Abstract>>"]
    class UI["UI\n<<Abstract>>"]
...
*UML class diagram of ATM interfaces: Deposit/Withdrawl/Transfer Transaction classes each depend on a corresponding abstract UI class, and all three UI classes inherit from an abstract UI base class.*

<details>
<summary>Original figure</summary>

![UML diagram: Deposit, Withdrawl, and Transfer Transaction classes each depending on corresponding DepositUI, WithdrawlUI, Tr…](Interface_Segration_Principle/assets/page-009-img-02.png)
...
UML diagram: Deposit, Withdrawl, and Transfer Transaction classes each depending on corresponding DepositUI, WithdrawlUI, TransferUI abstract classes, all multiply inherited into abstract UI class
