...
> ***S**OFTWARE **E**NTITIES (**C**LASSES, **M**ODULES, **F**UNCTIONS, **E**TC.) **S**HOULD **BE** **OPEN** **FOR** **EXTENSION**, **BUT** **CLOSED** **FOR** **MODIFICATION**.*
...
![Booch diagram: Client and Server cloud classes connected by a uses relationship](Open-Closed_Principle/assets/page-002-img-01.png)
...
![Booch diagram: Client connected to abstract class Abstract Server, with Server deriving from it](Open-Closed_Principle/assets/page-003-img-01.png)
...
*A UML/Booch-style diagram showing class A containing class B by value (composition), with a code snippet 'class A { private: B itsB; };' and text explaining identical lifetimes.*

<details>
<summary>Original figure</summary>

![Diagram: A contains B by value (filled square marker); Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-01.png)
...
*Booch cloud-notation diagram showing class A using class B (circle-and-line 'uses' relationship), illustrated by the C++ code where class A declares a method taking a const B& parameter.*

<details>
<summary>Original figure</summary>

![Diagram: A uses B (open circle marker); Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-02.png)
...
*A UML-style notation diagram showing class A containing class B by reference (A holds a B* itsB pointer, so B may outlive A), illustrated with blob shapes A and B connected by a line with a filled dot on A's side and a hollow square on B's side.\*

<details>
<summary>Original figure</summary>

![Diagram: A contains B by reference (open square marker); Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-03.png)
...
classDiagram
    B <|-- D
    note for B "Inheritance. This indicates that B is a public base class of D."
    note for D "class D : public B {...};"
```

*A UML-style inheritance notation diagram showing class D derived from public base class B, with the corresponding C++ declaration 'class D : public B {...};'.*

<details>
<summary>Original figure</summary>

![Diagram: D inherits from B (arrow with hollow triangle); Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-04.png)
...
![Diagram: A invokes member function M of B with arguments P and V; Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-05.png)
...
![Diagram: A uses Set template containing B (0..n multiplicity); Booch-style cloud notation](Open-Closed_Principle/assets/page-014-img-06.png)
