...
Moritz Mock<sup>[0009−0009−3156−6211]</sup>, Jorge Melegati<sup>[0000−0003−1303−4173]</sup>, and Barbara Russo<sup>[0000−0003−3737−9264]</sup>
...
flowchart LR
  ...
  DP[["Prompt"]]
  DT[["Test<br/>Prompt"]]
  DET[["Error Trace<br/>Code<br/>Test<br/>Prompt"]]
...
*A numbered 5-step TDD-with-LLM workflow flowchart (Specify prompt, Develop failing test, Develop code, Execute tests, Choose prompt) with document artifacts, a Pass/Fail decision, a Repeat loop, and feedback arrows.*
