...
![Table 3 diagram with axes Level of Coverage and Level of Consistency, four type cells (Type A: Treasure, Type B: Mixture of…](Software-Product-Line-Evolution-Method/assets/page-004-img-01.png)
...
Table 3 diagram with axes Level of Coverage and Level of Consistency, four type cells (Type A: Treasure, Type B: Mixture of Chaff and Grain, Type C: Gemstones, Type D: Stones), and blue arrows labeled (1), (2), (3) showing scenario paths from Type B to Type C
...
flowchart TD
  ...
  A["Plan core asset Kaizen"] --> B["Kaizen core assets"]
  B --> C["Develop products by reusing the core assets"]
  C --> D["Evaluate results of Kaizen"]
  D --> E["Feed know-how back to the standard"]
  E --> A
...
*A PDCA (Plan-Do-Check-Act) circular cycle of Kaizen processes, with inner process boxes flowing around a loop and connected to 'Standard' and 'Core assets' data stores.*

<details>
<summary>Original figure</summary>

![Circular PDCA cycle diagram: Plan (Plan core asset Kaizen), Do (Kaizen core assets, Develop products by reusing the core ass…](Software-Product-Line-Evolution-Method/assets/page-006-img-01.png)
...
Circular PDCA cycle diagram: Plan (Plan core asset Kaizen), Do (Kaizen core assets, Develop products by reusing the core assets), Check (Evaluate results of Kaizen), Act (Feed know-how back to the standard), with Core assets and Standard cylinders in center
...
$$\begin{aligned}
\textit{Cost savings} &= \sum C_{old\_way} - \sum C_{new\_way} - C_{del} - C_{ref}\\
&\textit{(Here, $\sum$ means sum of total number of products)}
\end{aligned}$$
...
xychart-beta
    ...
    y-axis "Cumulative cost" -8.0 --> 4.0
    line "s12:Detoxing-->Refactoring" [-4.00, -6.50, -5.00, -2.75, -0.50, 1.75]
    line "s13:Refactoring-->Detoxing" [-3.00, -5.00, -3.40, -1.00, 1.40, 3.80]
```

*A line chart showing cumulative cost effects for two scenarios (s12: Detoxing->Refactoring and s13: Refactoring->Detoxing) across six WBS categories (05a-07b), with an accompanying data table.*

<details>
<summary>Original figure</summary>

![Line chart showing cumulative effects for s12:Detoxing-->Refactoring and s13:Refactoring-->Detoxing from 05a to 07b, with va…](Software-Product-Line-Evolution-Method/assets/page-006-img-02.png)
...
Line chart showing cumulative effects for s12:Detoxing-->Refactoring and s13:Refactoring-->Detoxing from 05a to 07b, with values table below
...
![Table 5 with hand-drawn blue annotation circles around cells 0.25, 0.9, 0.225 and totals 12.25 and 12.5, with leader lines t…](Software-Product-Line-Evolution-Method/assets/page-007-img-01.png)

*Blue annotation graphics in Table 5 region*

<details>
<summary>Image description</summary>

Table 5 with hand-drawn blue annotation circles around cells 0.25, 0.9, 0.225 and totals 12.25 and 12.5, with leader lines to labels (a)-(e)

</details>

**Table 5. Estimation of Development Costs**

**(1) Cost estimation for old way**
...
$$\textit{Cost savings} = \sum C_{evo} - \lbrace C_{org} + C_{cab} + \sum(C_{unique} + C_{reuse}) \rbrace$$
