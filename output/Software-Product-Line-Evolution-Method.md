...
![Table 3 diagram with blue arrows showing kaizen scenarios (1), (2), (3) between Type A/B/C/D quadrants](Software-Product-Line-Evolution-Method/assets/page-004-img-01.png)

*Table 3. Examples of Kaizen Scenarios*

| Level of Consistency<br>Level of Coverage | Consistent Core Assets | Inconsistent Core Assets           |
| :---------------------------------------- | :--------------------- | :--------------------------------- |
| All Kinds of Software Artifacts           | Type A: Treasure       | Type B: Mixture of Chaff and Grain |
| Some Kinds of Software Artifacts          | Type C: Gemstones      | Type D: Stones                     |
...
![PDCA cycle diagram: Plan core asset Kaizen, Do Kaizen core assets / Develop products by reusing the core assets, Check Evalu…](Software-Product-Line-Evolution-Method/assets/page-006-img-01.png)
...
PDCA cycle diagram: Plan core asset Kaizen, Do Kaizen core assets / Develop products by reusing the core assets, Check Evaluate results of Kaizen, Act Feed know-how back to the standard, around Standard and Core assets cylinders
...
$$\text{Cost savings} = \sum C_{old\_way} - \sum C_{new\_way} - C_{del} - C_{ref}$$
...
xychart-beta
    ...
    y-axis "Cumulative effect" -8.00 --> 2.00
    line "s1.2: Detoxing --> Refactoring" [-4.00, -6.50, -5.00, -2.75, -0.50, 1.75]
    line "s1.3: Refactoring --> Detoxing" [-3.00, -5.00, -3.40, -1.00, 1.40, 3.80]
```

*Figure 2: a line chart of cumulative effects for two scenarios (s1.2 Detoxing->Refactoring and s1.3 Refactoring->Detoxing) across six periods (05a-07b), with an embedded data table of the plotted values.*

<details>
<summary>Original figure</summary>

![Line chart of cumulative effects for s12 (Detoxing-->Refactoring) and s13 (Refactoring-->Detoxing) from 05a to 07b, with dat…](Software-Product-Line-Evolution-Method/assets/page-006-img-02.png)
...
Line chart of cumulative effects for s12 (Detoxing-->Refactoring) and s13 (Refactoring-->Detoxing) from 05a to 07b, with data table: s12: -4.00, -6.50, -5.00, -2.75, -0.50, 1.75; s13: -3.00, -5.00, -3.40, -1.00, 1.40, 3.80
...
| Modification                      |  0.5  |  1.5  | 0.5  |  2  | (e) 4.5 |
...
The above equation assumes that an organization will develop new core assets. Our method considers C$_{del}$ and C$_{ref}$ in addition to C$_{cab}$. These costs are indispensable when the organization maintains the product line for a long time and changes it with time.
