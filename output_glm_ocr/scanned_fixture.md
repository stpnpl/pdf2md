...
classDiagram
    Derived1 --|> [Base Class]
    Derived2 --|> [Base Class]
    [Base Class] o-- [Had by Reference]
    [Base Class] *-- [Had By Value]
    [Base Class] ..> Used
```

*A Booch/UML-style class-notation sidebar showing a Base Class with two derived subclasses, an aggregation (hollow diamond) to 'Had by Reference', a composition (filled diamond) to 'Had By Value', and a dashed dependency arrow to 'Used'.*

<details>
<summary>Original figure</summary>

![Sidebar: Unified Notation 0.8 diagram showing a Base Class with a dashed 'Used' arrow to another box, 'Had by Reference' and…](scanned_fixture/assets/page-001-img-01.png)
...
Sidebar: Unified Notation 0.8 diagram showing a Base Class with a dashed 'Used' arrow to another box, 'Had by Reference' and 'Had By Value' associations, and Derived 1 and Derived 2 boxes connected by a generalization triangle
...
*Figure 1 shows a class diagram where Square inherits from Rectangle via a generalization arrow.*

<details>
<summary>Original figure</summary>

![Figure 1. Boxed inheritance diagram: Rectangle box connected by an inheritance arrow (hollow triangle) down to Square box.](scanned_fixture/assets/page-003-img-01.png)
