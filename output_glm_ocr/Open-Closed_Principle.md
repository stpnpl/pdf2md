...
As Ivar Jacobson said: "All systems change during their life cycles. This must be borne in mind when developing systems expected to last longer than the first version."<sup>1</sup> How can we create designs that are stable in the face of change and that will last longer than the first version? Bertrand Meyer<sup>2</sup> gave us guidance as long ago as 1988 when he coined the now famous open-closed principle. To paraphrase him:
...
![Booch diagram: dashed cloud Client connected to Server](Open-Closed_Principle/assets/page-002-img-01.png)
...
![Booch diagram: Client (dashed cloud) connected to Abstract Server (dashed cloud with A), with Server (dashed cloud) deriving…](Open-Closed_Principle/assets/page-003-img-02.png)
...
Booch diagram: Client (dashed cloud) connected to Abstract Server (dashed cloud with A), with Server (dashed cloud) deriving from Abstract Server
...
*A UML-style containment-by-value diagram showing object A connected to object B (with filled connection markers indicating by-value containment), plus the code 'class A { private: B itsB; }' and text explaining identical lifetimes.*

<details>
<summary>Original figure</summary>

![Booch notation: contains-by-value relationship between clouds A and B with filled square](Open-Closed_Principle/assets/page-014-img-01.png)
</details>
...
![Booch notation: contains-by-reference relationship between clouds A and B with unfilled square](Open-Closed_Principle/assets/page-014-img-02.png)
...
![Booch notation: invoking a member function, arrows labeled P, M, V from A to B](Open-Closed_Principle/assets/page-014-img-03.png)
...
![Booch notation: uses relationship, cloud A connected to cloud B by a line with open circle](Open-Closed_Principle/assets/page-014-img-04.png)
...
```mermaid
classDiagram
    B <|-- D : public inheritance

*A class diagram blob showing D publicly inheriting from B, with the C++ declaration 'class D : public B {...};'.*

<details>
<summary>Original figure</summary>

![Booch notation: inheritance, arrow from cloud D to cloud B](Open-Closed_Principle/assets/page-014-img-05.png)
</details>
...
![Booch notation: using a container class, A contains a Set box of B with 0..n B elements](Open-Closed_Principle/assets/page-014-img-06.png)
