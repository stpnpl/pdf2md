...
![Sidebar: Unified Notation 0.8 diagram showing Base Class used (dashed arrow) by Used, associated with Had by Reference and H…](Dependency_Inversion_Principle/assets/page-001-img-01.png)
...
Sidebar: Unified Notation 0.8 diagram showing Base Class used (dashed arrow) by Used, associated with Had by Reference and Had By Value, and inherited by Derived 1 and Derived 2
...
*A module hierarchy (structure chart) showing a top module 'Copy' that calls two subordinate modules 'Read Keyboard' and 'Write Printer'.*

<details>
<summary>Original figure</summary>

![Figure 1. Copy Program. Structure chart showing the Copy module at the top calling Read Keyboard and Write Printer modules b…](Dependency_Inversion_Principle/assets/page-003-img-01.png)
...
Figure 1. Copy Program. Structure chart showing the Copy module at the top calling Read Keyboard and Write Printer modules below.
...
![Listing 1. The Copy Program](Dependency_Inversion_Principle/assets/page-004-img-01.png)
...
![Listing 2. The "Enhanced" Copy Program](Dependency_Inversion_Principle/assets/page-004-img-02.png)
...
*UML class diagram of the OO Copy Program: Copy aggregates abstract Reader and abstract Writer classes, with KeyboardReader and PrinterWriter as concrete subclasses respectively.*

<details>
<summary>Original figure</summary>

![UML class diagram of the OO Copy program](Dependency_Inversion_Principle/assets/page-005-img-01.png)
...
![Listing 4: Copy using stdio.h — boxed code listing](Dependency_Inversion_Principle/assets/page-006-img-04.png)
...
*A layered-architecture diagram titled 'Simple Layers' showing three stacked boxes connected by dashed downward arrows: Policy Layer, Mechanism Layer, and Utility Layer.*

<details>
<summary>Original figure</summary>

![Figure 3: Simple Layers diagram](Dependency_Inversion_Principle/assets/page-007-img-01.png)
...
```mermaid
classDiagram
    class PolicyLayer["Policy Layer"]
    class MechanismInterface["Mechanism Interface\n<<Abstract>>"]
    class MechanismLayer["Mechanism Layer"]
    class UtilityInterface["Utility Interface\n<<Abstract>>"]
    class UtilityLayer["Utility Layer"]
...
*UML class diagram showing Policy Layer depending on the abstract Mechanism Interface, which is realized by the Mechanism Layer, which in turn depends on the abstract Utility Interface realized by the Utility Layer.*

<details>
<summary>Original figure</summary>

![Figure 4: Abstract Layers diagram](Dependency_Inversion_Principle/assets/page-007-img-02.png)
...
![Figure 5: Naive Button/Lamp Model — Button and Lamp connected by TurnOn/TurnOff messages, and a contains relationship betwee…](Dependency_Inversion_Principle/assets/page-009-img-01.png)
...
Figure 5: Naive Button/Lamp Model — Button and Lamp connected by TurnOn/TurnOff messages, and a contains relationship between Button and Lamp
...
In Figure 6, we have isolated the abstraction of the Button class, from its detailed implementation. Listing 6 shows the corresponding code. Note that the high level policy is entirely captured within the ![Figure 6: Inverted Button Model](Dependency_Inversion_Principle/assets/page-010-img-01.png)
...
classDiagram
    ...
    LampAdapter o-- Lamp
    ButtonImplementation --|> Button
    LampAdapter --|> ButtonClient
```

*UML class diagram showing ButtonClient aggregating Button, LampAdapter aggregating Lamp, and ButtonImplementation/LampAdapter inheriting from Button/ButtonClient respectively.*

<details>
<summary>Original figure</summary>

![Figure 7: Lamp Adapter — UML diagram with Button, ButtonClient, Button Implementation, Lamp Adapter, and Lamp](Dependency_Inversion_Principle/assets/page-011-img-01.png)
