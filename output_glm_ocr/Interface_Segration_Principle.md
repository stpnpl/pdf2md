...
*UML class diagram: Base Class inherits to Derived 1 and Derived 2, aggregates 'Had by Reference' (open diamond), composes 'Had By Value' (filled diamond), and has a dashed dependency arrow to 'Used'.*

<details>
<summary>Original figure</summary>

![Sidebar: Unified Notation 0.8 — UML class diagram showing a Base Class with a dashed 'Used' dependency to a Used class, aggr…](Interface_Segration_Principle/assets/page-001-img-01.png)
...
Sidebar: Unified Notation 0.8 — UML class diagram showing a Base Class with a dashed 'Used' dependency to a Used class, aggregation diamonds to 'Had by Reference' and 'Had By Value' classes, and generalization to Derived 1 and Derived 2
...
classDiagram
    TimerClient <|-- Door
    Door <|-- TimedDoor
    note "TimerClient at top of hierarchy"
```

*UML class hierarchy showing TimedDoor inheriting from Door, which inherits from TimerClient, with TimerClient placed at the top of the hierarchy.*

<details>
<summary>Original figure</summary>

![UML diagram: TimedDoor inherits from Door, which inherits from TimerClient](Interface_Segration_Principle/assets/page-003-img-01.png)
...
*UML class diagram showing TimedDoor inheriting from abstract Door, DoorTimerAdapter inheriting from abstract TimerClient, with an aggregation/association between TimedDoor and DoorTimerAdapter.*

<details>
<summary>Original figure</summary>

![UML diagram: TimedDoor inherits from Door (abstract); DoorTimerAdapter inherits from TimerClient (abstract); DoorTimerAdapte…](Interface_Segration_Principle/assets/page-006-img-02.png)
...
UML diagram: TimedDoor inherits from Door (abstract); DoorTimerAdapter inherits from TimerClient (abstract); DoorTimerAdapter aggregates TimedDoor
...
classDiagram
    ...
    note for TimedDoor "Figure 3: Multiply Inherited Timed Door"
```

*UML class diagram showing TimedDoor inheriting (with hollow-triangle generalization arrows) from both Door and TimerClient, illustrating multiple inheritance.*

<details>
<summary>Original figure</summary>

![UML diagram: TimedDoor inherits from both Door and TimerClient](Interface_Segration_Principle/assets/page-007-img-01.png)
...
*UML class diagram showing an abstract class 'ATM UI' with three subclasses 'Braille UI', 'Screen UI', and 'Speech UI' inheriting from it.*

<details>
<summary>Original figure</summary>

![UML diagram: abstract class ATM UI inheriting to Braille UI, Screen UI, Speech UI](Interface_Segration_Principle/assets/page-008-img-01.png)
...
*UML class diagram showing abstract Transaction specialized by Deposit, Withdrawl, and Transfer transactions, each depending on an abstract UI interface (Figure 6, Segregated ATM UI Interface).*

<details>
<summary>Original figure</summary>

![UML diagram: Transaction abstract class with Deposit, Withdrawl, and Transfer Transaction derivatives, all depending on abst…](Interface_Segration_Principle/assets/page-009-img-01.png)
...
UML diagram: Transaction abstract class with Deposit, Withdrawl, and Transfer Transaction derivatives, all depending on abstract UI class
...
*UML class diagram showing three abstract classes (Deposit UI, Withdrawl UI, Transfer UI) inheriting from the abstract UI base class.*

<details>
<summary>Original figure</summary>

![UML diagram: Deposit, Withdrawl, and Transfer Transactions each depending on separate DepositUI, WithdrawlUI, and TransferUI…](Interface_Segration_Principle/assets/page-009-img-02.png)
...
UML diagram: Deposit, Withdrawl, and Transfer Transactions each depending on separate DepositUI, WithdrawlUI, and TransferUI abstract classes, multiply inherited into abstract UI
