...
![Workflow diagram of the fully-automated pattern with activities: Specify prompt, Develop failing test, Develop code, Execute…](Generative_AI_for_Test_Driven_Development_-_arxiv/assets/page-004-img-01.png)
...
Workflow diagram of the fully-automated pattern with activities: Specify prompt, Develop failing test, Develop code, Execute tests, Pass/fail? decision, Choose prompt, Repeat loop
...
1. In the 'test_TwoWordSpreadEven' test, the 'TextFormatter' variable
   was mistakenly assigned instead of 'textFormatter'.
```
